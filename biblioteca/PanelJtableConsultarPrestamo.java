...
public class PanelJtableConsultarPrestamo extends JScrollPane implements MouseListener {
	 ...
	 * Create the panel.
	 */
	public PanelJtableConsultarPrestamo() {
		tabla = new JTable();
		tabla.setBounds(0, 0, 300, 300);
		this.setViewportView(tabla);
	}
	public PanelJtableConsultarPrestamo(Connection conn,String sql) {
		this.conn=conn;
